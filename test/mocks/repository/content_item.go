...
// Source: D:\Person\shiliu\internal\repository\content_item.go
...
// GetExportDataByID mocks base method.
func (m *MockContentItemRepository) GetExportDataByID(ctx context.Context, id uint) (*repository.ContentItemExportData, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetExportDataByID", ctx, id)
	ret0, _ := ret[0].(*repository.ContentItemExportData)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetExportDataByID indicates an expected call of GetExportDataByID.
func (mr *MockContentItemRepositoryMockRecorder) GetExportDataByID(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetExportDataByID", reflect.TypeOf((*MockContentItemRepository)(nil).GetExportDataByID), ctx, id)
}
